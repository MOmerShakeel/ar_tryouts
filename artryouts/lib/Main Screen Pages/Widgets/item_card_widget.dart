...
import 'package:artryouts/Main%20Screen%20Pages/U_ItemDetailPage.dart';
...
class ItemCardList extends StatelessWidget {
  ...
  Card buildCard(int index) {
    return Card(
      ...
      color:
          index % 2 == 0 ? Colors.teal : const Color.fromARGB(255, 0, 128, 128),
      child: Stack(
        children: [
          Container(
            width: cardWidth,
          ...
          (hasSubtext && !isTrending) ||
                  (isTrending && items[index].ar_link != null)
              ? const Positioned(
                  right: 10,
                  top: 10,
                  child: Icon(
